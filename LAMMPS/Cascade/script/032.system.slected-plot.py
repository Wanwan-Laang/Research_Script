...
data = pd.read_csv('./combined_seletced_region.csv')
print(data.head())
...
plt.tight_layout()
plt.savefig("figure-select--Temperature-Evolution.pdf", dpi=1200,transparent=True)
...
plt.legend()
plt.savefig("figure-select--Energy-Evolution.pdf", dpi=1200,transparent=True)
